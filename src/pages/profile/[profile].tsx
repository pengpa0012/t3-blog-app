    ...
    <main className="max-w-[1200px] mx-auto p-6">
      ...
      </ul>
      {
        ...
        <>
          ...
          <input type="text" placeholder='Title...' className='border border-gray-500 rounded-md bg-inherit w-full my-2 text-md p-2 outline-none' />
          <textarea placeholder='Description' className='border border-gray-500 rounded-md bg-inherit w-full my-2 text-md p-2 outline-none min-h-[300px] resize-none'></textarea>
